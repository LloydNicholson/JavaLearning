...
public class Main {
	...
	private static MobilePhone mobile = new MobilePhone("0823004043");
	...
	private static void modifyContact() {
		...
		if (mobile.modifyContact(existingContactRecord, newContact)) {
			System.out.println("Successfully updated record. " + existingContactRecord.getName() + " was replaced with "+ newName);
		} else {
	...
	public static void startPhone() { System.out.println("Starting phone..."); }
